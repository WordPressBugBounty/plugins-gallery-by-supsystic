...
class Twig_SupTwgSgg_Environment
{
  ...
  public function createTemplate($template)
  {
    ...
    $loader = new Twig_SupTwgSgg_Loader_Chain([new Twig_SupTwgSgg_Loader_Array([$name => $template]), ($current = $this->getLoader())]);
  ...
  protected function initExtensions()
  {
    ...
    $this->parsers = new Twig_SupTwgSgg_TokenParserBroker([], [], false);
    $this->filters = [];
    $this->functions = [];
    $this->tests = [];
    $this->visitors = [];
  ...
  {
    $hashParts = array_merge(array_keys($this->extensions), [(int) function_exists('Twig_SupTwgSgg_template_get_attributes'), PHP_MAJOR_VERSION, PHP_MINOR_VERSION, self::VERSION, (int) $this->debug, $this->baseTemplateClass, (int) $this->strictVariables]);
