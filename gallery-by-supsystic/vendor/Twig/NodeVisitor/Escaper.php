...
class Twig_SupTwgSgg_NodeVisitor_Escaper extends Twig_SupTwgSgg_BaseNodeVisitor
{
  ...
  protected function isSafeFor($type, Twig_SupTwgSgg_NodeInterface $expression, $env)
  {
    ...
    if (null === $safe) {
      if (null === $this->traverser) {
        $this->traverser = new Twig_SupTwgSgg_NodeTraverser($env, [$this->safeAnalysis]);
      }
  ...
  protected function getEscaperFilter($type, Twig_SupTwgSgg_NodeInterface $node)
  {
    ...
    $args = new Twig_SupTwgSgg_Node([new Twig_SupTwgSgg_Node_Expression_Constant((string) $type, $line), new Twig_SupTwgSgg_Node_Expression_Constant(null, $line), new Twig_SupTwgSgg_Node_Expression_Constant(true, $line)]);
