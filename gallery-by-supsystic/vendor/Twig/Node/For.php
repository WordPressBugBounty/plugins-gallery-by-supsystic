...
class Twig_SupTwgSgg_Node_For extends Twig_SupTwgSgg_Node
{
  ...
  public function __construct(
    ...
    if (null !== $ifexpr) {
      $body = new Twig_SupTwgSgg_Node_If(new Twig_SupTwgSgg_Node([$ifexpr, $body]), null, $lineno, $tag);
    }
  ...
  {
    $compiler->addDebugInfo($this)->write("\$context['_parent'] = \$context;\n")->write("\$context['_seq'] = Twig_SupTwgSgg_ensure_traversable(")->subcompile($this->getNode('seq'))->raw(");\n");
