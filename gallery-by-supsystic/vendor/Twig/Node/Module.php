...
class Twig_SupTwgSgg_Node_Module extends Twig_SupTwgSgg_Node
{
  ...
  public function __construct(Twig_SupTwgSgg_NodeInterface $body, ?Twig_SupTwgSgg_Node_Expression $parent = null, ?Twig_SupTwgSgg_NodeInterface $blocks = null, ?Twig_SupTwgSgg_NodeInterface $macros = null, ?Twig_SupTwgSgg_NodeInterface $traits = null, $embeddedTemplates = null, $name = null, $source = '')
  {
  ...
  protected function compileTemplate(Twig_SupTwgSgg_Compiler $compiler)
  {
    ...
    if (count($this->getNode('blocks')) || count($this->getNode('traits')) || !$this->hasNode('parent') || $this->getNode('parent') instanceof Twig_SupTwgSgg_Node_Expression_Constant || count($this->getNode('constructor_start')) || count($this->getNode('constructor_end'))) {
  ...
  {
    $compiler->write("public function __construct(Twig_SupTwgSgg_Environment \$env)\n", "{\n")->indent()->subcompile($this->getNode('constructor_start'))->write("parent::__construct(\$env);\n\n");
  ...
  protected function compileIsTraitable(Twig_SupTwgSgg_Compiler $compiler)
  {
    ...
    if ($traitable) {
      ...
      if (!count($nodes)) {
        $nodes = new Twig_SupTwgSgg_Node([$nodes]);
      }
