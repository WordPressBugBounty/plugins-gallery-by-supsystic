...
class Twig_SupTwgSgg_Parser implements Twig_SupTwgSgg_ParserInterface
{
  ...
  public function parse(Twig_SupTwgSgg_TokenStream $stream, $test = null, $dropNeedle = false)
  {
    ...
    $node = new Twig_SupTwgSgg_Node_Module(new Twig_SupTwgSgg_Node_Body([$body]), $this->parent, new Twig_SupTwgSgg_Node($this->blocks), new Twig_SupTwgSgg_Node($this->macros), new Twig_SupTwgSgg_Node($this->traits), $this->embeddedTemplates, $stream->getSourceContext());
      ...
      switch ($this->getCurrentToken()->getType()) {
        ...
        case Twig_SupTwgSgg_Token::BLOCK_START_TYPE:
          ...
          if (null !== $test && call_user_func($test, $token)) {
            ...
            return new Twig_SupTwgSgg_Node($rv, [], $lineno);
          }
  ...
  {
    $this->blocks[$name] = new Twig_SupTwgSgg_Node_Body([$value], [], $value->getTemplateLine());
  }
  ...
  protected function filterBodyNodes(Twig_SupTwgSgg_NodeInterface $node)
  {
    ...
    if (($node instanceof Twig_SupTwgSgg_Node_Text && !ctype_space($node->getAttribute('data'))) || (!$node instanceof Twig_SupTwgSgg_Node_Text && !$node instanceof Twig_SupTwgSgg_Node_BlockReference && $node instanceof Twig_SupTwgSgg_NodeOutputInterface)) {
