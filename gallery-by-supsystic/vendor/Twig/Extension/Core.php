...
class Twig_SupTwgSgg_Extension_Core extends Twig_SupTwgSgg_Extension
{
  ...
  public function getFilters()
  {
    $filters = [
      // formatting filters
      new Twig_SupTwgSgg_SimpleFilter('date', 'Twig_SupTwgSgg_date_format_filter', ['needs_environment' => true]),
      new Twig_SupTwgSgg_SimpleFilter('date_modify', 'Twig_SupTwgSgg_date_modify_filter', ['needs_environment' => true]),
      new Twig_SupTwgSgg_SimpleFilter('format', 'sprintf'),
      new Twig_SupTwgSgg_SimpleFilter('replace', 'Twig_SupTwgSgg_replace_filter'),
      new Twig_SupTwgSgg_SimpleFilter('number_format', 'Twig_SupTwgSgg_number_format_filter', ['needs_environment' => true]),
      ...
      // string filters
      new Twig_SupTwgSgg_SimpleFilter('title', 'Twig_SupTwgSgg_title_string_filter', ['needs_environment' => true]),
      new Twig_SupTwgSgg_SimpleFilter('capitalize', 'Twig_SupTwgSgg_capitalize_string_filter', ['needs_environment' => true]),
      ...
      new Twig_SupTwgSgg_SimpleFilter('nl2br', 'nl2br', ['pre_escape' => 'html', 'is_safe' => ['html']]),

      // array helpers
      new Twig_SupTwgSgg_SimpleFilter('join', 'Twig_SupTwgSgg_join_filter'),
      new Twig_SupTwgSgg_SimpleFilter('split', 'Twig_SupTwgSgg_split_filter', ['needs_environment' => true]),
      ...
      new Twig_SupTwgSgg_SimpleFilter('reverse', 'Twig_SupTwgSgg_reverse_filter', ['needs_environment' => true]),
      new Twig_SupTwgSgg_SimpleFilter('length', 'Twig_SupTwgSgg_length_filter', ['needs_environment' => true]),
      new Twig_SupTwgSgg_SimpleFilter('slice', 'Twig_SupTwgSgg_slice', ['needs_environment' => true]),
      new Twig_SupTwgSgg_SimpleFilter('first', 'Twig_SupTwgSgg_first', ['needs_environment' => true]),
      new Twig_SupTwgSgg_SimpleFilter('last', 'Twig_SupTwgSgg_last', ['needs_environment' => true]),

      // iteration and runtime
      new Twig_SupTwgSgg_SimpleFilter('default', '_Twig_SupTwgSgg_default_filter', ['node_class' => 'Twig_SupTwgSgg_Node_Expression_Filter_Default']),
      new Twig_SupTwgSgg_SimpleFilter('keys', 'Twig_SupTwgSgg_get_array_keys_filter'),

      // escaping
      new Twig_SupTwgSgg_SimpleFilter('escape', 'Twig_SupTwgSgg_escape_filter', ['needs_environment' => true, 'is_safe_callback' => 'Twig_SupTwgSgg_escape_filter_is_safe']),
      new Twig_SupTwgSgg_SimpleFilter('e', 'Twig_SupTwgSgg_escape_filter', ['needs_environment' => true, 'is_safe_callback' => 'Twig_SupTwgSgg_escape_filter_is_safe']),
    ];

    $filters[] = new Twig_SupTwgSgg_SimpleFilter('upper', 'Twig_SupTwgSgg_upper_filter', ['needs_environment' => true]);
    $filters[] = new Twig_SupTwgSgg_SimpleFilter('lower', 'Twig_SupTwgSgg_lower_filter', ['needs_environment' => true]);
  ...
  public function getFunctions()
  {
    return [
      ...
      new Twig_SupTwgSgg_SimpleFunction('random', 'Twig_SupTwgSgg_random', ['needs_environment' => true]),
      new Twig_SupTwgSgg_SimpleFunction('date', 'Twig_SupTwgSgg_date_converter', ['needs_environment' => true]),
      new Twig_SupTwgSgg_SimpleFunction('include', 'Twig_SupTwgSgg_include', ['needs_environment' => true, 'needs_context' => true, 'is_safe' => ['all']]),
      new Twig_SupTwgSgg_SimpleFunction('source', 'Twig_SupTwgSgg_source', ['needs_environment' => true, 'is_safe' => ['all']]),
    ];
  }
  ...
  {
    return [
      new Twig_SupTwgSgg_SimpleTest('even', null, ['node_class' => 'Twig_SupTwgSgg_Node_Expression_Test_Even']),
      new Twig_SupTwgSgg_SimpleTest('odd', null, ['node_class' => 'Twig_SupTwgSgg_Node_Expression_Test_Odd']),
      new Twig_SupTwgSgg_SimpleTest('defined', null, ['node_class' => 'Twig_SupTwgSgg_Node_Expression_Test_Defined']),
      new Twig_SupTwgSgg_SimpleTest('sameas', null, ['node_class' => 'Twig_SupTwgSgg_Node_Expression_Test_Sameas', 'deprecated' => '1.21', 'alternative' => 'same as']),
      new Twig_SupTwgSgg_SimpleTest('same as', null, ['node_class' => 'Twig_SupTwgSgg_Node_Expression_Test_Sameas']),
      new Twig_SupTwgSgg_SimpleTest('none', null, ['node_class' => 'Twig_SupTwgSgg_Node_Expression_Test_Null']),
      new Twig_SupTwgSgg_SimpleTest('null', null, ['node_class' => 'Twig_SupTwgSgg_Node_Expression_Test_Null']),
      new Twig_SupTwgSgg_SimpleTest('divisibleby', null, ['node_class' => 'Twig_SupTwgSgg_Node_Expression_Test_Divisibleby', 'deprecated' => '1.21', 'alternative' => 'divisible by']),
      new Twig_SupTwgSgg_SimpleTest('divisible by', null, ['node_class' => 'Twig_SupTwgSgg_Node_Expression_Test_Divisibleby']),
      new Twig_SupTwgSgg_SimpleTest('constant', null, ['node_class' => 'Twig_SupTwgSgg_Node_Expression_Test_Constant']),
  ...
  public function getOperators()
  {
    return [
      [
        'not' => ['precedence' => 50, 'class' => 'Twig_SupTwgSgg_Node_Expression_Unary_Not'],
        '-' => ['precedence' => 500, 'class' => 'Twig_SupTwgSgg_Node_Expression_Unary_Neg'],
        '+' => ['precedence' => 500, 'class' => 'Twig_SupTwgSgg_Node_Expression_Unary_Pos'],
      ],
      [
        'or' => ['precedence' => 10, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_Or', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        'and' => ['precedence' => 15, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_And', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        'b-or' => ['precedence' => 16, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_BitwiseOr', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        'b-xor' => ['precedence' => 17, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_BitwiseXor', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        'b-and' => ['precedence' => 18, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_BitwiseAnd', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '==' => ['precedence' => 20, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_Equal', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '!=' => ['precedence' => 20, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_NotEqual', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '<' => ['precedence' => 20, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_Less', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '>' => ['precedence' => 20, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_Greater', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '>=' => ['precedence' => 20, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_GreaterEqual', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '<=' => ['precedence' => 20, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_LessEqual', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        'not in' => ['precedence' => 20, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_NotIn', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        'in' => ['precedence' => 20, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_In', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        'matches' => ['precedence' => 20, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_Matches', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        'starts with' => ['precedence' => 20, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_StartsWith', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        'ends with' => ['precedence' => 20, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_EndsWith', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '..' => ['precedence' => 25, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_Range', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '+' => ['precedence' => 30, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_Add', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '-' => ['precedence' => 30, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_Sub', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '~' => ['precedence' => 40, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_Concat', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '*' => ['precedence' => 60, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_Mul', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '/' => ['precedence' => 60, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_Div', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '//' => ['precedence' => 60, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_FloorDiv', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '%' => ['precedence' => 60, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_Mod', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        'is' => ['precedence' => 100, 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        'is not' => ['precedence' => 100, 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_LEFT],
        '**' => ['precedence' => 200, 'class' => 'Twig_SupTwgSgg_Node_Expression_Binary_Power', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_RIGHT],
        '??' => ['precedence' => 300, 'class' => 'Twig_SupTwgSgg_Node_Expression_NullCoalesce', 'associativity' => Twig_SupTwgSgg_ExpressionParser::OPERATOR_RIGHT],
      ],
    ];
  }
 ...
 */
function Twig_SupTwgSgg_include(Twig_SupTwgSgg_Environment $env, $context, $template, $variables = [], $withContext = true, $ignoreMissing = false, $sandboxed = false)
{
