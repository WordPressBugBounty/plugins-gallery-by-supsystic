...
class RscSgg_Mvc_Module
{
  ...
  public function __call($method, $arguments)
  {
    ...
    return call_user_func_array([$this->environment, $method], $arguments);
  }
  ...
  public function handle()
  {
    ...
    if (method_exists($controller, $action)) {
      ...
      return call_user_func_array([$controller, $action], [$this->request]);
    }

    $twig = $this->environment->getTwig();

    return RscSgg_Http_Response::create()->setContent(
      $twig->render('404.twig', [
  ...
  private function createController()
  {
    ...
    if ($this->overloadController) {
      ...
      $path = $config->get('pro_modules_path') . '/' . $prefix . '/' . $module;
    }
