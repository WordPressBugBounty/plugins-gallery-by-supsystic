...
class GridGallery_SocialSharing_Module extends GridGallery_Core_Module
{
  ...
  {
    parent::onInit();
    add_action('sgg_disable_social_sharing', [$this, 'disableSocialSharing'], 10, 1);
    add_action('sgg_clean_cache', [$this, 'cleanSocialSharingCache'], 10, 1);
  ...
  public function onRequest()
  {
    ...
    $sh = $this->getEnvironment()
      ->getTwig()
      ->render('@socialsharing/shareImage.twig', [
