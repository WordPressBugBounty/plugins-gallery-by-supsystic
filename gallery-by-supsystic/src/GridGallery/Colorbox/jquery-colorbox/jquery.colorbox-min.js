...
(function (t, e, i) {
  ...
  function p() {
    !x &&
      ...
      (y = n(se, 'Wrapper')),
      (b = n(se, 'Content').append((I = n(se, 'Title')), (R = n(se, 'Current')), (P = t('<button type="button"/>').attr({ id: Z + 'Previous' })), (K = t('<button type="button"/>').attr({ id: Z + 'Next' })), (F = n('button', 'Slideshow')), S)),
      (B = t('<button type="button"/>').attr({ id: Z + 'Close' })),
      y
        .append(n(se).append(n(se, 'TopLeft'), (T = n(se, 'TopCenter')), n(se, 'TopRight')), n(se, !1, 'clear:left').append((C = n(se, 'MiddleLeft')), b, (H = n(se, 'MiddleRight'))), n(se, !1, 'clear:left').append(n(se, 'BottomLeft'), (k = n(se, 'BottomCenter')), n(se, 'BottomRight')))
        .find('div div')
        .css({ float: 'left' }),
  ...
  function w() {
    ...
    if (
      ...
      (_.mw = _.w),
      (_.mh = _.h),
      _.get('maxWidth') && ((_.mw = a(_.get('maxWidth'), 'x') - N - j), (_.mw = _.w && _.w < _.mw ? _.w : _.mw)),
      _.get('maxHeight') && ((_.mh = a(_.get('maxHeight'), 'y') - A - D), (_.mh = _.h && _.h < _.mh ? _.h : _.mh)),
      (e = _.get('href')),
  ...
  t.colorbox ||
      ...
      ((de = r),
        ...
        x.dequeue().animate(r, {
          ...
          complete: function () {
            (n(),
              (q = !1),
              (y[0].style.width = _.w + N + j + 'px'),
              (y[0].style.height = _.h + A + D + 'px'),
              _.get('reposition') &&
                setTimeout(function () {
    ...
    (J.resize = function (t) {
      ...
      $ &&
        ...
        t.innerHeight || t.height || ((e = L.scrollTop()), L.css({ height: 'auto' }), (_.h = L.height())),
        L.css({ height: _.h }),
        e && L.scrollTop(e),
