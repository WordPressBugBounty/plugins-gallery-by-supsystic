...
class GridGallery_Optimization_Controller extends GridGallery_Core_BaseController
{
  ...
  {
    return ['saveSettingsAction', 'getPhotoListAction', 'optimizeOneImageAction', 'saveOptimizeInfoToDbAction', 'rollbackRestoredImgAction', 'saveCdnSettingsAction', 'transferOneImageAction', 'saveCdnInfoToDbAction'];
  }
