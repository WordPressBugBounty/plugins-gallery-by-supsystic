            ...
            function (t) {
              ...
              for (; h < t.length; )
                ((r = t.charCodeAt(h++)),
                  ...
                  (s = ((15 & n) << 2) | (i >> 6)),
                  (l = 63 & i),
                  h === t.length + 2 ? ((s = 64), (l = 64)) : h === t.length + 1 && (l = 64),
    ...
    return (function (t) {
      ...
      function (t, e, r) {
        (function (e) {
          ...
          function i(t, e) {
            var r = { theme: T(U.settings.themes.gray, null), stylesheets: e.stylesheets, instanceOptions: e },
              n = t.indexOf('?'),
              i = [t];
            -1 !== n && (i = [t.slice(0, n), t.slice(n + 1)]);
            var o = i[0].split('/');
            r.holderURL = t;
            var a = o[1],
              s = a.match(/([\d]+p?)x([\d]+p?)/);
            if (!s) return !1;
            if (((r.fluid = -1 !== a.indexOf('p')), (r.dimensions = { width: s[1].replace('p', '%'), height: s[2].replace('p', '%') }), 2 === i.length)) {
              var l = v.parse(i[1]);
              if (
                (l.bg && (r.theme.bg = w.parseColor(l.bg)),
                l.fg && (r.theme.fg = w.parseColor(l.fg)),
                l.bg && !l.fg && (r.autoFg = !0),
                l.theme && r.instanceOptions.themes.hasOwnProperty(l.theme) && (r.theme = T(r.instanceOptions.themes[l.theme], null)),
                ...
                (r.nowrap = w.truthy(l.nowrap)),
                (r.auto = w.truthy(l.auto)),
                (r.outline = w.truthy(l.outline)),
                w.truthy(l.random))
              ) {
          ...
          function o(t) {
            ...
            var m = n.holderURL,
              v = T(i, null);
            if ((n.font && ((s.font = n.font), !v.noFontFallback && 'img' === r.nodeName.toLowerCase() && U.setup.supportsCanvas && 'svg' === v.renderer && (v = T(v, { renderer: 'canvas' }))), n.font && 'canvas' == v.renderer && (v.reRender = !0), 'background' == e))
              null == r.getAttribute('data-background-src') && E.setAttr(r, { 'data-background-src': m });
            else {
              var y = {};
              ((y[U.vars.dataAttr] = m), E.setAttr(r, y));
            }
            ((n.theme = s), (r.holderData = { flags: n, engineSettings: v }), ('image' == e || 'fluid' == e) && E.setAttr(r, { alt: s.text ? (c ? s.text : s.text + ' [' + l + ']') : l }));
            var b = { mode: e, el: r, holderSettings: { dimensions: o, theme: s, flags: n }, engineSettings: v };
            'image' == e
              ? (n.auto || ((r.style.width = o.width + 'px'), (r.style.height = o.height + 'px')), 'html' == v.renderer ? (r.style.backgroundColor = s.background) : (a(b), 'exact' == n.textmode && ((r.holderData.resizeUpdate = !0), U.vars.resizableImages.push(r), h(r))))
              : 'background' == e && 'html' != v.renderer
                ? a(b)
                : 'fluid' == e &&
                  ((r.holderData.resizeUpdate = !0),
                  '%' == o.height.slice(-1) ? (r.style.height = o.height) : (null != n.auto && n.auto) || (r.style.height = o.height + 'px'),
                  '%' == o.width.slice(-1) ? (r.style.width = o.width) : (null != n.auto && n.auto) || (r.style.width = o.width + 'px'),
                  ('inline' == r.style.display || '' === r.style.display || 'none' == r.style.display) && (r.style.display = 'block'),
                  u(r),
                  'html' == v.renderer ? (r.style.backgroundColor = s.background) : (U.vars.resizableImages.push(r), h(r)));
          }
          function a(t) {
            function r() {
              var e = null;
            ...
            ('background' == i
              ? ((o.style.backgroundImage = 'url(' + n + ')'), (o.style.backgroundSize = h.width + 'px ' + h.height + 'px'))
              : ('img' === o.nodeName.toLowerCase() ? E.setAttr(o, { src: n }) : 'object' === o.nodeName.toLowerCase() && E.setAttr(o, { data: n, type: 'image/svg+xml' }),
                l.reRender &&
                  e.setTimeout(function () {
                    var t = r();
                    if (null == t) throw "Holder: couldn't render placeholder";
                    'img' === o.nodeName.toLowerCase() ? E.setAttr(o, { src: t }) : 'object' === o.nodeName.toLowerCase() && E.setAttr(o, { data: t, type: 'image/svg+xml' });
                  }, 150)),
              E.setAttr(o, { 'data-holder-rendered': !0 }));
          }
          function s(t) {
            function e(t, e, r, n) {
            ...
            switch (
              (parseFloat(t.theme.size) ? (r = t.theme.size) : parseFloat(t.flags.size) && (r = t.flags.size),
              (t.font = { family: t.theme.font ? t.theme.font : 'Arial, Helvetica, Open Sans, sans-serif', size: l(t.width, t.height, r, U.defaults.scale), units: t.theme.units ? t.theme.units : U.defaults.units, weight: t.theme.fontweight ? t.theme.fontweight : 'bold' }),
            ...
            var n = t.flags.lineWrap || U.setup.lineWrapRatio,
              ...
              s = a.Shape,
              h = new s.Rect('holderBg', { fill: t.theme.bg });
            if ((h.resize(t.width, t.height), a.root.add(h), t.flags.outline)) {
              var u = new A(h.properties.fill);
              ((u = u.lighten(u.lighterThan('7f7f7f') ? -0.1 : 0.1)), (h.properties.outline = { fill: u.toHex(!0), width: 2 }));
            }
            var f = t.theme.fg;
            if (t.flags.autoFg) {
              var c = new A(h.properties.fill),
                d = new A('fff'),
                p = new A('000', { alpha: 0.285714 });
              f = c.blendAlpha(c.lighterThan('7f7f7f') ? p : d).toHex(!0);
            }
            var g = new s.Group('holderTextGroup', { text: t.text, align: t.align, font: t.font, fill: f });
            ...
            if (m.lineCount > 1) {
              ...
              ((v = new s.Text(t.text)),
                ...
                w.add(v),
                g.add(w),
                'left' === t.align ? g.moveTo(t.width - i, null, null) : 'right' === t.align ? g.moveTo(0 - (t.width - i), null, null) : g.moveTo((t.width - m.boundingBox.width) / 2, null, null),
            ...
            if (t.holderData) {
              ...
              if (e) {
                var r = t.holderData.flags,
                  n = { fluidHeight: '%' == r.dimensions.height.slice(-1), fluidWidth: '%' == r.dimensions.width.slice(-1), mode: null, initialDimensions: e };
          ...
          function p(t) {
            (U.vars.debounceTimer || t.call(this),
              U.vars.debounceTimer && e.clearTimeout(U.vars.debounceTimer),
              (U.vars.debounceTimer = e.setTimeout(function () {
          ...
          var m = r(2),
            ...
            C = {
              ...
              run: function (t) {
                ...
                return (
                  ...
                  (r.noFontFallback = a.noFontFallback ? a.noFontFallback : !1),
                  ...
                  l.forEach(function (t) {
                    if (e.getComputedStyle) {
                      ...
                      if (null != h) {
                        var d = i(h, a);
                        d && o({ mode: 'background', el: t, flags: d, engineSettings: r });
                      }
                    }
                  }),
            ...
            U = {
              settings: {
                ...
                themes: { gray: { bg: '#EEEEEE', fg: '#AAAAAA' }, social: { bg: '#3a5a97', fg: '#FFFFFF' }, industrial: { bg: '#434A52', fg: '#C2F200' }, sky: { bg: '#0D8FDB', fg: '#FFFFFF' }, vine: { bg: '#39DBAC', fg: '#1E292C' }, lava: { bg: '#F8591A', fg: '#1C2846' } },
              },
              ...
              return function (n) {
                ...
                if (U.setup.supportsSVG) {
                  ...
                  ((null == t || t.parentNode !== document.body) && (o = !0),
                    (t = b.initSVG(t, i.properties.width, i.properties.height)),
                    (t.style.display = 'block'),
                    o && ((e = E.newEl('text', R)), (r = a(null)), E.setAttr(e, { x: 0 }), e.appendChild(r), t.appendChild(e), document.body.appendChild(t), (t.style.visibility = 'hidden'), (t.style.position = 'absolute'), (t.style.top = '-100%'), (t.style.left = '-100%')));
                  var s = i.children.holderTextGroup,
                    l = s.properties;
                  (E.setAttr(e, { y: l.font.size, style: w.cssProps({ 'font-weight': l.font.weight, 'font-size': l.font.size + l.font.units, 'font-family': l.font.family }) }), (r.nodeValue = l.text));
                  var h = e.getBBox(),
                  ...
                  if (u > 1) {
                    ...
                    for (var v = 0; v < f.length; v++)
                      if (0 !== f[v].length) {
                        ...
                        var y = e.getBBox();
                        m.push({ text: f[v], width: y.width });
                      }
                  }
                  return ((t.style.display = 'none'), { spaceWidth: g, lineCount: u, boundingBox: h, words: m });
                }
                return !1;
              };
            })();
          for (var P in U.flags)
            U.flags.hasOwnProperty(P) &&
              (U.flags[P].match = function (t) {
                return t.match(this.regex);
              });
          ((U.setup = { renderer: 'html', debounce: 100, ratio: 1, supportsCanvas: !1, supportsSVG: !1, lineWrapRatio: 0.9, dataAttr: 'data-src', renderers: ['html', 'canvas', 'svg'] }),
            (U.vars = { preempted: !1, resizableImages: [], invisibleImages: {}, invisibleId: 0, visibilityCheckStarted: !1, debounceTimer: null, cache: {} }),
            (function () {
            ...
            m &&
              m(function () {
                (U.vars.preempted || C.run(),
                  e.addEventListener ? (e.addEventListener('resize', g, !1), e.addEventListener('orientationchange', g, !1)) : e.attachEvent('onresize', g),
      ...
      function (t, e, r) {
        (function (t, n) {
          ...
          function a(e, r) {
            if (((e = g(e, 0 > r ? 0 : 0 | m(r))), !t.TYPED_ARRAY_SUPPORT)) for (var n = 0; r > n; n++) e[n] = 0;
            return e;
          }
          function s(t, e, r) {
          ...
          ((t.prototype.slice = function (e, r) {
            ...
            (t.prototype.writeUInt16LE = function (e, r, n) {
              return ((e = +e), (r = 0 | r), n || O(this, e, r, 2, 65535, 0), t.TYPED_ARRAY_SUPPORT ? ((this[r] = 255 & e), (this[r + 1] = e >>> 8)) : k(this, e, r, !0), r + 2);
            }),
            (t.prototype.writeUInt16BE = function (e, r, n) {
              return ((e = +e), (r = 0 | r), n || O(this, e, r, 2, 65535, 0), t.TYPED_ARRAY_SUPPORT ? ((this[r] = e >>> 8), (this[r + 1] = 255 & e)) : k(this, e, r, !1), r + 2);
            }),
            (t.prototype.writeUInt32LE = function (e, r, n) {
              return ((e = +e), (r = 0 | r), n || O(this, e, r, 4, 4294967295, 0), t.TYPED_ARRAY_SUPPORT ? ((this[r + 3] = e >>> 24), (this[r + 2] = e >>> 16), (this[r + 1] = e >>> 8), (this[r] = 255 & e)) : D(this, e, r, !0), r + 4);
            }),
            (t.prototype.writeUInt32BE = function (e, r, n) {
              return ((e = +e), (r = 0 | r), n || O(this, e, r, 4, 4294967295, 0), t.TYPED_ARRAY_SUPPORT ? ((this[r] = e >>> 24), (this[r + 1] = e >>> 16), (this[r + 2] = e >>> 8), (this[r + 3] = 255 & e)) : D(this, e, r, !1), r + 4);
            }),
            ...
            (t.prototype.writeInt16LE = function (e, r, n) {
              return ((e = +e), (r = 0 | r), n || O(this, e, r, 2, 32767, -32768), t.TYPED_ARRAY_SUPPORT ? ((this[r] = 255 & e), (this[r + 1] = e >>> 8)) : k(this, e, r, !0), r + 2);
            }),
            (t.prototype.writeInt16BE = function (e, r, n) {
              return ((e = +e), (r = 0 | r), n || O(this, e, r, 2, 32767, -32768), t.TYPED_ARRAY_SUPPORT ? ((this[r] = e >>> 8), (this[r + 1] = 255 & e)) : k(this, e, r, !1), r + 2);
            }),
            (t.prototype.writeInt32LE = function (e, r, n) {
              return ((e = +e), (r = 0 | r), n || O(this, e, r, 4, 2147483647, -2147483648), t.TYPED_ARRAY_SUPPORT ? ((this[r] = 255 & e), (this[r + 1] = e >>> 8), (this[r + 2] = e >>> 16), (this[r + 3] = e >>> 24)) : D(this, e, r, !0), r + 4);
            }),
            (t.prototype.writeInt32BE = function (e, r, n) {
              return ((e = +e), (r = 0 | r), n || O(this, e, r, 4, 2147483647, -2147483648), 0 > e && (e = 4294967295 + e + 1), t.TYPED_ARRAY_SUPPORT ? ((this[r] = e >>> 24), (this[r + 1] = e >>> 16), (this[r + 2] = e >>> 8), (this[r + 3] = 255 & e)) : D(this, e, r, !1), r + 4);
            }),
            ...
            (t.prototype.copy = function (e, r, n, i) {
              ...
              var o,
                a = i - n;
              if (this === e && r > n && i > r) for (o = a - 1; o >= 0; o--) e[o + r] = this[o + n];
              else if (1e3 > a || !t.TYPED_ARRAY_SUPPORT) for (o = 0; a > o; o++) e[o + r] = this[o + n];
              ...
              e = Math.abs(e),
                isNaN(e) || e === 1 / 0
                  ...
                  : ((a = Math.floor(Math.log(e) / Math.LN2)),
                    ...
                    (e += a + f >= 1 ? c / l : c * Math.pow(2, 1 - f)),
                    e * l >= 2 && (a++, (l /= 2)),
                    a + f >= u ? ((s = 0), (a = u)) : a + f >= 1 ? ((s = (e * l - 1) * Math.pow(2, i)), (a += f)) : ((s = e * Math.pow(2, f - 1) * Math.pow(2, i)), (a = 0)));
              i >= 8;
      ...
      function (t, e) {
        var r = function (t) {
          ...
          i.prototype = new n();
          var o = function (t, r) {
            if ((n.call(this, t), (this.properties = { fill: '#000000' }), 'undefined' != typeof r)) e(this.properties, r);
      ...
      function (t, e) {
        (function (t) {
          ((e.extend = function (t, e) {
            ...
            (e.truthy = function (t) {
              return 'string' == typeof t ? 'true' === t || 'yes' === t || '1' === t || 'on' === t || '✓' === t : !!t;
            }),
        ...
        (function (t) {
          ...
          ((e.initSVG = function (t, e, r) {
            var a,
              s,
              l = !1;
            (t && t.querySelector ? ((s = t.querySelector('style')), null === s && (l = !0)) : ((t = n.newEl('svg', i)), (l = !0)),
              l && ((a = n.newEl('defs', i)), (s = n.newEl('style', i)), n.setAttr(s, { type: 'text/css' }), a.appendChild(s), t.appendChild(a)),
            ...
            return (n.setAttr(t, { width: e, height: r, viewBox: '0 0 ' + e + ' ' + r, preserveAspectRatio: 'none' }), t);
          }),
        ...
        (function (t) {
          ((e.newEl = function (e, r) {
            ...
            (e.getNodeArray = function (e) {
              var r = null;
              return (
                'string' == typeof e ? (r = document.querySelectorAll(e)) : t.NodeList && e instanceof t.NodeList ? (r = e) : t.Node && e instanceof t.Node ? (r = [e]) : t.HTMLCollection && e instanceof t.HTMLCollection ? (r = e) : e instanceof Array ? (r = e) : null === e && (r = []),
        ...
        ((r.rgb2hex = function (t, e, r) {
          ...
          (r.hsl2rgb = function (t, e, r) {
            var n = t / 60,
              ...
              h = 0;
            return (
              n >= 0 && 1 > n ? ((s = i), (l = o)) : n >= 1 && 2 > n ? ((s = o), (l = i)) : n >= 2 && 3 > n ? ((l = i), (h = o)) : n >= 3 && 4 > n ? ((l = o), (h = i)) : n >= 4 && 5 > n ? ((s = o), (h = i)) : n >= 5 && 6 > n && ((s = i), (h = o)),
              (s += a),
              (l += a),
              (h += a),
              (s = parseInt(255 * s)),
      ...
      function (t, e) {
        t.exports = { version: '2.9.1', svg_ns: 'http://www.w3.org/2000/svg' };
      },
      function (t, e, r) {
        function n(t, e) {
          return f.element({ tag: e, width: t.width, height: t.height, fill: t.properties.fill });
        }
        function i(t) {
          return h.cssProps({ fill: t.fill, 'font-weight': t.font.weight, 'font-family': t.font.family + ', monospace', 'font-size': t.font.size + t.font.units });
        }
        function o(t, e, r) {
          var n = r / 2;
          ...
          Object.keys(p.children).forEach(function (t) {
            ...
            Object.keys(e.children).forEach(function (t) {
              var r = e.children[t],
                n = p.x + e.x + r.x,
                i = p.y + e.y + r.y,
                o = f.element({ tag: 'text', content: r.properties.text, x: n, y: i });
              m.push(o);
            });
          });
          var v = f.element({ tag: 'g', content: m }),
            y = null;
          if (d.children.holderBg.properties.outline) {
            var w = d.children.holderBg.properties.outline;
            y = f.element({ tag: 'path', d: o(d.children.holderBg.width, d.children.holderBg.height, w.width), 'stroke-width': w.width, stroke: w.fill, fill: 'none' });
          }
          var b = n(d.children.holderBg, 'rect'),
            E = [];
          (E.push(b), w && E.push(y), E.push(v));
          var A = f.element({ tag: 'g', id: c, content: E }),
            x = f.element({ tag: 'style', content: g, type: 'text/css' }),
            S = f.element({ tag: 'defs', content: x }),
            I = f.element({ tag: 'svg', content: [S, A], width: d.properties.width, height: d.properties.height, xmlns: u, viewBox: [0, 0, d.properties.width, d.properties.height].join(' '), preserveAspectRatio: 'none' }),
            T = a(I);
          T = h + T[0];
      ...
      function (t, e, r) {
        ...
        t.exports = function n(t, e, r) {
          ...
          if (t[0] !== !1) {
            ...
            ((l += '>'),
              t[0].children.forEach(function (t) {
                l += t;
              }),
              (l += '</' + t[0].tag + '>'),
              (t[0] = l));
          ...
          return function (r) {
            ...
            ((e.fillStyle = a.properties.fill),
              ...
              a.properties.outline &&
                ((e.strokeStyle = a.properties.outline.fill), (e.lineWidth = a.properties.outline.width), e.moveTo(u, u), e.lineTo(s - u, u), e.lineTo(s - u, l - u), e.lineTo(u, l - u), e.lineTo(u, u), e.moveTo(0, u), e.lineTo(s, l - u), e.moveTo(0, l - u), e.lineTo(s, u), e.stroke()));
