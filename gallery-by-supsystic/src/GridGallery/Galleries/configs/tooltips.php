...
return [
  'tooltips' => [
    // settings page
    'sgg-shortcode' =>
      __('This shortcode helps you insert your gallery into post or page content. Just copy it and then paste the shortcode into your post or page body. ', 'sgg') .
    ...
    'sgg-php-code' => __('You may use PHPCode, if you need to insert a gallery shortcode to your php code directly. ', 'sgg') . '<a target=\'_blank\' href=\'https://supsystic.com/documentation/add-gallery-site-content\'>https://supsystic.com/documentation/add-gallery-site-content/</a>',
    // Area
    ...
    'gallery-align' =>
      __('Choose the most suitable gallery alignment for your site design. Gallery may be aligned by center, left or right side of the page. ', 'sgg') . '<a target=\'_blank\' href=\'https://supsystic.com/documentation/main-settings/\'>https://supsystic.com/documentation/main-settings</a>',
    ...
    'full-screen-width' =>
      __('Check this checkbox if you want your gallery to be displayed at full screen width. This option is of no use in Vertical gallery layout. Click the link below to see the example of Full Screen Width gallery. ', 'sgg') .
      '<a target=\'_blank\' href=\'https://supsystic.com/example/full-width-gallery-example/\'>https://supsystic.com/example/full-width-gallery-example/</a>',
    ...
    'open-by-link' =>
      __(
        'If this option is enabled, you may insert your gallery short link into 	the content of your page. In this case gallery thumbnails will not be displayed on the page and the gallery will open in pop-up box in the same window after clicking on the link. You may find the detailed instructions here: ',
        'sgg',
    ...
    'box-disableHistory' => __(
      'If this option is enabled, after clicking \'back\' button in your browser, pop-up window will be closed and all image data will be cleared. If disabled - images will be saved in browser history and will be opened again on \'back\' or \'forward\' button click.',
      'sgg',
    ),
    'box-disableChangeUrl' => __('If this option is enabled, browser url will not changed.', 'sgg'),

    'popupLinkedImageTextPro' => __(
      'Here you may choose the type of the text, which appears under your linked images after opening them in a pop-up. You may add this text when you choose the linked images from your site media library. Empty text fields will appear at the right side of the page after selecting the image.',
      'sgg',
    ),
    ...
    'paginationPro' =>
      __('This option allows you to split your gallery images to several pages for comfortable navigation. It may be useful for galleries with a great number of images.', 'sgg') .
      '</br><a target=\'_blank\' href=\'https://supsystic.com/documentation/pagination/\'>https://supsystic.com/documentation/pagination/</a></br></br>' .
      __('Use a Custom Buttons to establish a personal design for Load More Button, Pagination and Categories Buttons.', 'sgg') .
      ' <a target=\'_blank\' href=\'https://supsystic.com/documentation/custom-buttons/\'>https://supsystic.com/documentation/custom-buttons/</a>',
    ...
    'watermarkPro' =>
      __('This option enables Watermarks.', 'sgg') .
      '</br><a target=\'_blank\' href=\'https://supsystic.com/documentation/gallery-watermark/\'>https://supsystic.com/documentation/gallery-watermark/</a></br></br>' .
      __('Use a Custom Buttons to establish a personal design for Load More Button, Pagination and Categories Buttons.', 'sgg') .
      ' <a target=\'_blank\' href=\'https://supsystic.com/documentation/custom-buttons/\'>https://supsystic.com/documentation/custom-buttons/</a>',
    // lazy-load
    ...
    'polaroid-effect' =>
      ...
      '<a target=\'_blank\' href=\'https://supsystic.com/documentation/polaroid-gallery/\'>https://supsystic.com/documentation/polaroid-gallery/</a>',
    ...
    // horizontal scroll
    'horizontal-scroll' =>
      __('This option enables horizontal scroll bar for your gallery. You may customize your scroll bar below. Please note, that this option is not available for Mosaic gallery layout. ', 'sgg') .
